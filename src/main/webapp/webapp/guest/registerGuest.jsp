...
<html lang="en">
    ...
    <head>
        ...
        <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
             <title>PerfumeStore - Register</title>
    ...
    <body>
        <div class="box">
            <div class="container">
                <!--<form action="/PerfumeStore/guest/login" method="post">-->
                ...
                <div class="input-field">
                    <input type="date" id="birthday" name="birthday" class="input" value placeholder="dd/MM/yyyy">
                    <i class='bx bx-calendar-alt' style="color: #000"></i>
                </div>
