...
<html lang="en">
    ...
    <head>
        ...
        <style>
            body {
                background-image: url('/img/backgroup-employee.jpg');
        ...
        <div id="wrapper">
            <header>
                <div class="inner-header container-fluid" style="max-width: 1700px">
                    <img style="width: 120px; border-radius: 50%" src="/img/logo Perfume store.jpg" alt="Logo Perfume Store">
                    <%
                    ...
                    <nav>
                        <ul id="main-menu">
                            <li>
                                <c:choose>
                                    <c:when test="${sessionScope.phone != null}">
                                        <a href="/employee/orderListEmployees" class="menu-link">Order List</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="/employee/loginEmployees" class="menu-link">Order List</a>
                                    </c:otherwise>
                                </c:choose>
                            </li>
                            <!--                            <li>
                            ...
                            <li>
                                <a href="/employee/newOrderListEmployees" class="menu-link">New Order</a>
                            </li>
                            <%
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li><a style="color: black" href="/employee/updateProfileEmployees">Profile</a></li>
                                    <li><a style="color: black" href="/employee/changePasswordEmployees">Change Password</a></li>
                                    <li><a style="color: black" href="/employee/logoutEmployees">Logout <ion-icon style="display: inline-block; vertical-align: middle; margin-left: 2px; font-size: 24px;" name="log-out-outline"></ion-icon></a></li>
                                </ul>
                            </li>
                            <% }%>
                        </ul>
