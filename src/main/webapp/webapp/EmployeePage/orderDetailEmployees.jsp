    ...
    <body>
        ...
        <div class="container-fluid my-4" style="min-height: 100vh;
            ...
            <div class="d-flex justify-content-center">
                <div class="d-flex justify-content-center px-2 py-1 title my-3" style="color: white; background-color: #ff7c7c ">Order Detail</div>
            </div>
            <%
                    ...
                    <div class="box1">
                        <form id="updateForm" method="post" action="/employee?orderId=<%= orderId%>">
                            ...
                            <div class="customer-info mt-4">
                                <div>Customer: <span><%= customerInfo.getString("cus_name")%></span> <a id="more" href="/employee/customerInfoEmployees/<%=orderId%>/<%= customerInfo.getString("cus_phone")%>"><i class="fa-solid fa-circle-info"></i></a></div>
                        ...
                        <div style="width: 100%; margin: 0 10px 0 10px;">
                            <div style="height: 600px; overflow-y: auto; overflow-x: hidden;">
                                <table class="table table-bordered custom-table" style="width: 100%;">
                                    ...
                                    <thead>
                                        <tr align="center">
                                            <th scope="col" style="color: white;">Perfume</th>
