...
<html>
    ...
    <body>
        <jsp:include page="/EmployeePage/headerEmployees.jsp">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemList">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-outline-primary btnView" href="/orderDetailEmployees/<%= rs.getString("ord_id")%>" style="color: black;">View</a></td>
                            </tr>   
                            <%
                                }
                            %>
