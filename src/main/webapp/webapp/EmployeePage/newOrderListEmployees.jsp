                        ...
                        <td>
                            ...
                            <c:choose>
                                <c:when test="${sessionScope.phone!=null}">
                                    <a class="btn btn-outline-success btnTakeOrder" href="/employee/takeOrderEmployees/<%= rs.getString("ord_id")%>" style="font-weight: bold; font-size: 25px">Take Order</a>
                                </c:when>
                                <c:otherwise>
                                    <a class="btn btn-outline-success btnTakeOrder" href="/employee/loginEmployees" style="font-weight: bold; font-size: 25px">Take Order</a>
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>   
