...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" style="min-height: 125vh; padding-top: 90px;">
            <div class="title mx-auto my-5" style="color: white; background-color: #ff7c7c">Employee Information</div>
            <form action="/employee" method="post" onsubmit="return validateForm()">
                <div class="customer-info mx-auto p-4  d-flex flex-column justify-content-center" style=" background-color: rgba(0, 0, 0, 0.5); padding: 20px; border-radius: 10px; color: #fff;"">
                    <div class="d-flex">
                ...
                <div class="btnBack mx-auto my-5 d-flex">
                    <button type="submit" value="Update" name="btnUpdateProfile" style="color: white;">Update</button>
