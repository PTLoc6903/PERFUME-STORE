...
<html lang="en">
    ...
    <head>
        ...
        <title>PerfumeStore managers</title>
                ...
                <div class="orders-table">
                    ...
                    <div id="tableContainer">
                        <table>
                            <thead>
                                <tr>
                                    <th data-filter="orderId" onclick="sortTable(0)" style="background-color: white; color: black;">Order ID</th>
                                    <th data-filter="status" onclick="sortTable(1)" style="background-color: white; color: black;">Status</th>
                                    <th data-filter="dateOrder" onclick="sortTable(2)" style="background-color: white; color: black;">Date Order</th>
                                    <th data-filter="phone" onclick="sortTable(3)" style="background-color: white; color: black;">Phone Customer</th>
                                    <th data-filter="paymentMethods" onclick="sortTable(4)" style="background-color: white; color: black;">Payment Methods</th>
                                    <th data-filter="total" onclick="sortTable(5)" style="background-color: white; color: black;">Total</th>
                            ...
                            <tbody id="itemList">
                                <c:forEach var="m" items="${requestScope.listOrderM}">
                                    <tr>
                                        ...
                                        <td>${m.ord_pay}</td>
                                        <td>${m.ord_total}$</td>
                                        <td class="view-link"><a href="orderDetailsManager?bid=${m.ord_id}" class="view">View</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
