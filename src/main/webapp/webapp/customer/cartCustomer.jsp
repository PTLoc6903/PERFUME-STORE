                        ...
                        <tbody>
                            <c:forEach var="cart" items="${requestScope.carts}">
                                <tr>
                                    ...
                                    <td style="font-size: 23px;"> <a href="#">${cart.getPerfume().getName()}</a> </td>
...
<!--                            <button class="voucher" onclick="useVoucher()"><ion-icon name="gift"></ion-icon>Use</button>-->
                    ...
                    <li>
                        ...
                        <span>
                            ...
                            %>
                            <div class="info">
                                <p style="font-size: 20px;"><span class="bold-numbers">Total Perfume Cost: </span>${sum}$</p>
                            </div>
                            <div class="info">
