...
<html>
    ...
    <body>
        <aside>
            <div class="sidebar">
                <a href="analyticsManager" class="logo-side">
                    <div class="logo-name">
                        <div class="Campus">PerfumeStore</div>
                        <div class="Munchines">Manager</div>
                    </div>
                </a>
                <ul class="side-menu">
                    <li id="analyticsManager"><a href="analyticsManager"><i class='bx bx-home-heart'></i> Analytics</a></li>
                    <li id="orderManager"><a href="orderManager"><i class='bx bx-store'></i> Order</a></li>
                    <li id="listMenuManager">
                        <a href="listMenuManager"><i class='bx bx-notepad'></i> Menu</a>
                        <ul class="sub-menu">
                            <li><a href="listMenuManager">List Menu</a></li>
                    ...
                    <li id="employeeManager">
                        ...
                        <ul class="sub-menu">
                            <li><a href="employeeManager">List Employee</a></li>
                            <li><a href="createAccountManager">Create Account</a></li>
                        </ul>
                    </li>
