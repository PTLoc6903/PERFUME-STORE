    ...
    <body>
        ...
        <div class="container-i">
            ...
            <main>
                ...
                <form action="addPerfumeManager" method="POST">
                    <div class="perfume-info">
                        <div class="left-info">
                            <ul>
                                <li><label>Perfume ID: </label><input type="text" name="perfume_id" value="${perfume_id}" readonly></li>

                                <li><label>Perfume Name: </label><input type="text" name="perfume_name" value></li>
            ...
            <script>
                ...
                document.querySelector('.btn-add-product button').addEventListener('click', function (event) {
                    ...
                    if (!perfumeName || isNaN(price) || isNaN(sale) || sale === undefined || image === '' || imageUrl === '' || category_name === '' || description === '' || description === null || status === '') {
                        Swal.fire({
                            icon: 'error',
