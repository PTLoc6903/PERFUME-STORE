            ...
            <main>
                ...
                <div class="search-main">
                    <div class="search-container">
                        <input type="text" class="search-box" id="searchInput" placeholder="Search Name Perfume...">
                    </div>
                    <div class="filter">
                        <label>Category filter: </label>
                        <select class="select-box">
                            <option value="All" selected>All</option>
                            <option value="CAT001">Children perfumes</option>
                            <option value="CAT002">Comic</option>
                            <option value="CAT003">Textperfume</option>
                            <option value="CAT004">Psychology perfumes</option>
                ...
                <table class="table table-striped" id="perfumeList">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Price</th>
...
<!--                                    <button class="btn btn-update" onclick="updatePerfume('${m.id}')">Update</button>
                                    ...
                                    <button class="btn btn-detail" style="background-color: white; color: blue;" onclick="viewPerfumeDetail('${m.id}')">View</button>
